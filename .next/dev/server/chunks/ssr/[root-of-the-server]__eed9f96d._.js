...
"[project]/frontend/node_modules/next-themes/dist/index.module.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const t = [
    "light",
    "dark"
], n = "(prefers-color-scheme: dark)", r = "undefined" == ("TURBOPACK compile-time value", "undefined"), o = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"](void 0), a = {
    setTheme: (e)=>{},
    themes: []
}, s = ()=>{
    var t;
    return null !== (t = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"](o)) && void 0 !== t ? t : a;
}, c = (t)=>__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"](o) ? /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], null, t.children) : /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createElement"](l, t), l = ({ forcedTheme: r, disableTransitionOnChange: a = !1, enableSystem: s = !0, enableColorScheme: c = !0, storageKey: l = "theme", themes: h = [
    "light",
    "dark"
], defaultTheme: f = s ? "system" : "light", attribute: v = "data-theme", value: y, themeColor: g, children: $, nonce: b })=>{
    const [S, p] = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"](()=>r ? "forced" : i(l, f)), [C, w] = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"](()=>i(l)), E = y ? Object.values(y) : h, T = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"](), k = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"](), x = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"](), L = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"]((e)=>{
        let n = e;
        if (!n) return;
        "system" === e && s && (n = d());
        const r = y ? y[n] : n, o = a ? u() : null, l = document.documentElement;
        if ("class" === v ? (l.classList.remove(...E), r && l.classList.add(r)) : r ? l.setAttribute(v, r) : l.removeAttribute(v), g) {
            let e = !1;
            const t = (m = "string" == typeof g ? g : g[n]).startsWith("var(--") ? (k.current || (k.current = getComputedStyle(document.documentElement)), k.current.getPropertyValue(m.slice(4, -1))) : m, r = (()=>{
                var t;
                if (null == (t = T.current) ? void 0 : t.isConnected) return T.current;
                const n = document.head.querySelector('meta[name="theme-color"]');
                if (n) return n;
                const r = document.createElement("meta");
                return r.setAttribute("name", "theme-color"), e = !0, r;
            })();
            T.current = r, t && (r.removeAttribute("value"), r.setAttribute("content", t), e && document.head.appendChild(r));
        }
        var m;
        if (c) {
            const e = t.includes(f) ? f : null, r = t.includes(n) ? n : e;
            l.style.colorScheme = r;
        }
        null == o || o();
    }, []), A = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"]((e)=>{
        if (p(e), !r) try {
            localStorage.setItem(l, e);
        } catch (e) {}
    }, [
        r
    ]), I = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"]((e)=>{
        const t = d(e);
        w(t), "system" === S && s && !r && L("system");
    }, [
        S,
        r
    ]);
    return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"](()=>{
        ...
        const e = (e)=>{
            e.key === l && (r && e.newValue ? x.current = e.newValue : A(e.newValue || f));
        };
        return window.addEventListener("storage", e), ()=>window.removeEventListener("storage", e);
    }, [
        A
    ]), __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"](()=>{
        if (r && "forced" !== S && A("forced"), !r && x.current) return A(x.current), L(x.current), void (x.current = void 0);
        L(null != r ? r : S);
    }, [
        r,
        S
    ]), /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createElement"](o.Provider, {
        value: {
            theme: S,
            setTheme: A,
            resolvedTheme: (null != r ? r : "system" === S) ? C : S,
            themes: s ? [
                ...h,
                "system"
            ] : h,
    ...
    }, /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createElement"](m, {
        forcedTheme: r,
...
}, m = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["memo"](({ forcedTheme: r, storageKey: o, attribute: a, enableSystem: s, enableColorScheme: c, defaultTheme: l, value: m, attrs: i, nonce: u })=>{
    const d = "system" === l, h = "class" === a ? `var d=document.documentElement,c=d.classList;c.remove(${i.map((e)=>`'${e}'`).join(",")});` : `var d=document.documentElement,n='${a}',s='setAttribute';`, f = c ? t.includes(l) && l ? `if(e==='light'||e==='dark'||!e)d.style.colorScheme=e||'${l}'` : "if(e==='light'||e==='dark')d.style.colorScheme=e" : "", v = (e, n = !1, r = !0)=>{
        const o = m ? m[e] : e, s = n ? e + "|| ''" : `'${o}'`;
        let l = "";
        return c && r && !n && t.includes(e) && (l += `d.style.colorScheme = '${e}';`), "class" === a ? l += n || o ? `c.add(${s})` : "null" : o && (l += `d[s](n,${s})`), l;
    }, y = r ? `!function(){${h}${v(r)}}()` : s ? `!function(){try{${h}var e=localStorage.getItem('${o}');if('system'===e||(!e&&${d})){var t='${n}',m=window.matchMedia(t);if(m.media!==t||m.matches){${v("dark")}}else{${v("light")}}}else if(e){${m ? `var x=${JSON.stringify(m)};` : ""}${v(m ? "x[e]" : "e", !0)}}${d ? "" : "else{" + v(l, !1, !1) + "}"}${f}}catch(e){}}()` : `!function(){try{${h}var e=localStorage.getItem('${o}');if(e){${m ? `var x=${JSON.stringify(m)};` : ""}${v(m ? "x[e]" : "e", !0)}}else{${v(l, !1, !1)};}${f}}catch(t){}}();`; /*#__PURE__*/ 
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eed9f96d._.js.map