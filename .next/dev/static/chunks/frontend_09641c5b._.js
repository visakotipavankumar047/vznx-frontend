                ...
                "DashboardPage.useEffect.fetchStats": async ()=>{
                    try {
                        ...
                        const totalTasks = projects.reduce({
                            "DashboardPage.useEffect.fetchStats.totalTasks": (sum, p)=>sum + (p.taskSummary?.total || 0)
                        }["DashboardPage.useEffect.fetchStats.totalTasks"], 0);
                        const completedTasks = projects.reduce({
                            "DashboardPage.useEffect.fetchStats.completedTasks": (sum, p)=>sum + (p.taskSummary?.completed || 0)
                        }["DashboardPage.useEffect.fetchStats.completedTasks"], 0);
                        setStats({
                            totalProjects: projects.length,
                            inProgress: projects.filter({
                                "DashboardPage.useEffect.fetchStats": (p)=>p.status === 'In Progress'
                            }["DashboardPage.useEffect.fetchStats"]).length,
                            completed: projects.filter({
                                "DashboardPage.useEffect.fetchStats": (p)=>p.status === 'Completed'
                            }["DashboardPage.useEffect.fetchStats"]).length,
...
_s(DashboardPage, "8FYVvPkO2WqAnF/pBtJhy8BdxBY=");
_c = DashboardPage;
var _c;
...
//# sourceMappingURL=frontend_09641c5b._.js.map